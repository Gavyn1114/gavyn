...
Below are my notes for Cambridge's IGCSE Computer Science 0478 (for assessment from 2023 onwards, with last assessment in 2028).

#### Notes
To be added.

#### Question banks
I strongly believe that scoring 60+ out of 75 is very easy on the Paper 1, as it is mostly just rote memorisation. There is very little variation in the possible questions that can come up on Paper 1. As long as you have 'memorised' (although I would prefer using the word 'understand') all the mark schemes in the question banks attached below, it is more than sufficient to score at an A* level.

I strongly recommend using [Anki](https://apps.ankiweb.net/) to memorise all the content.
